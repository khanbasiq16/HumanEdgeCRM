...
import {
  ArrowLeft, Save, Loader2, FileDown, ChevronLeft,
  Grid, Type, Image as ImageIcon, Tag, Palette,
  AlignLeft, AlignCenter, AlignRight, Trash2, Copy,
  Building2, X, MoveUp, MoveDown, Layers, LayoutList,
  PenLine, MousePointer2, Pen, Paintbrush, Eraser, User,
} from "lucide-react";
...
const getContrastColors = (bg) => {
  ...
  if (h.length !== 6) return { isDark:false, text:"#0f172a", sub:"#64748b", accent:"#059669", line:"#e2e8f0", altLine:"#cbd5e1" };
...
const LETTER_TEMPLATES = [
  {
    ...
    desc:"Formal appreciation & recognition letter",
    preview:(bg,cc)=>(
    ...
    build:(pW,pH,cc,co,gId)=>{
      ...
      push({type:"i-text",text:"To,\n[Employee Name]\n[Designation]\n[Department]",x:50,y:148,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-100});
      push({type:"line",x:50,y:230,points:[0,0,pW-100,0],stroke:cc.altLine,strokeWidth:1,fill:"transparent"});
      push({type:"i-text",text:"Subject: Letter of Appreciation",x:50,y:248,fontSize:13,fontFamily:"Arial",fontWeight:"bold",fill:cc.accent});
      push({type:"i-text",text:"Dear [Employee Name],",x:50,y:280,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-100});
      push({type:"i-text",text:"On behalf of the management at [Company Name], we are truly pleased to formally\nacknowledge your outstanding performance, unwavering dedication, and the significant\ncontributions you have made to our organization.",x:50,y:308,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-100});
      push({type:"rect",x:50,y:390,width:pW-100,height:60,fill:cc.line,stroke:"transparent",strokeWidth:0,cornerRadius:6});
      push({type:"i-text",text:"Your hard work and dedication have directly contributed to the growth of [Company Name].\nWe deeply value your service.",x:64,y:406,fontSize:12,fontFamily:"Arial",fill:cc.accent,width:pW-128});
      push({type:"i-text",text:"We look forward to your continued growth within the organization.\n\nWarm regards,",x:50,y:470,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-100});
  ...
  },
  {
    ...
    desc:"Employment offer / appointment letter",
    preview:(bg,cc)=>(
      <div className="w-full h-full flex flex-col overflow-hidden" style={{background:bg,padding:6}}>
    ...
    build:(pW,pH,cc,co,gId)=>{
      ...
      push({type:"i-text",text:"Date: [Date]",x:pW-170,y:108,fontSize:11,fontFamily:"Arial",fill:cc.sub,width:120});
      push({type:"line",x:50,y:130,points:[0,0,pW-100,0],stroke:cc.altLine,strokeWidth:1,fill:"transparent"});
      push({type:"i-text",text:"To,\n[Employee Name]\n[Designation]",x:50,y:148,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-100});
      push({type:"i-text",text:"Dear [Employee Name],",x:50,y:218,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-100});
      push({type:"i-text",text:"We are pleased to offer you the position of [Designation] in the [Department] Department\nat [Company Name]. We are confident you will be a valuable addition to our team.",x:50,y:246,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-100});
      push({type:"i-text",text:"TERMS & CONDITIONS",x:50,y:310,fontSize:13,fontFamily:"Arial",fontWeight:"bold",fill:"#1e3a8a"});
      push({type:"rect",x:50,y:330,width:pW-100,height:120,fill:"#f0f9ff",stroke:"#bfdbfe",strokeWidth:1,cornerRadius:6});
      push({type:"i-text",text:"Position:          [Designation]\nDepartment:        [Department]\nDate of Joining:   [Join Date]\nMonthly Salary:    PKR [Salary]\nProbation Period:  3 Months",x:70,y:346,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-140});
      push({type:"i-text",text:"Please sign and return a copy of this letter as your acceptance.",x:50,y:470,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-100});
      push({type:"line",x:50,y:pH-190,points:[0,0,pW-100,0],stroke:cc.altLine,strokeWidth:1,fill:"transparent"});
      push({type:"i-text",text:"",x:60,y:pH-142,fontSize:34,fontFamily:"'Dancing Script',cursive",fill:cc.text,width:220});
      push({type:"line",x:60,y:pH-96,points:[0,0,220,0],stroke:cc.text,strokeWidth:1,fill:"transparent"});
      push({type:"i-text",text:"AUTHORIZED SIGNATORY",x:60,y:pH-84,fontSize:9,fontFamily:"Arial",fontWeight:"bold",fill:cc.sub});
      ...
      push({type:"i-text",text:"[Employee Name]",x:rx,y:pH-70,fontSize:10,fontFamily:"Arial",fill:cc.text});
      return s;
    },
  },
  {
    id:"experience-letter", name:"Experience Certificate", category:"Exit", headerH:85,
    desc:"Service / experience certificate",
    preview:(bg,cc)=>(
      <div className="w-full h-full flex flex-col overflow-hidden" style={{background:bg,padding:6}}>
    ...
    build:(pW,pH,cc,co,gId)=>{
      ...
      push({type:"line",x:50,y:140,points:[0,0,pW-100,0],stroke:cc.altLine,strokeWidth:1,fill:"transparent"});
      push({type:"i-text",text:"This is to certify that [Employee Name] (Employee ID: [Employee ID]) has served\nas [Designation] in the [Department] Department at [Company Name].",x:50,y:160,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-100});
      push({type:"rect",x:50,y:222,width:pW-100,height:80,fill:cc.line,stroke:"transparent",strokeWidth:0,cornerRadius:6});
      push({type:"i-text",text:"Date of Joining:  [Join Date]\nDate of Leaving:  [To Date]\nTotal Duration:   [Duration]",x:70,y:238,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-140});
      push({type:"i-text",text:"During [his/her] tenure, [Employee Name] demonstrated exceptional professionalism.\n[He/She] was diligent, hardworking, and a valued member of our team.\n\nWe wish [him/her] all the best in future endeavors.",x:50,y:322,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-100});
      push({type:"i-text",text:"Date: [Date]",x:pW-180,y:430,fontSize:11,fontFamily:"Arial",fill:cc.sub,width:130});
      push({type:"line",x:50,y:pH-190,points:[0,0,pW-100,0],stroke:cc.altLine,strokeWidth:1,fill:"transparent"});
      push({type:"i-text",text:"",x:60,y:pH-142,fontSize:34,fontFamily:"'Dancing Script',cursive",fill:cc.text,width:220});
      push({type:"line",x:60,y:pH-96,points:[0,0,220,0],stroke:cc.text,strokeWidth:1,fill:"transparent"});
      push({type:"i-text",text:"AUTHORIZED SIGNATORY",x:60,y:pH-84,fontSize:9,fontFamily:"Arial",fontWeight:"bold",fill:cc.sub});
  ...
  },
  {
    ...
    build:(pW,pH,cc,co,gId)=>{
      ...
      push({type:"line",x:50,y:230,points:[0,0,pW-100,0],stroke:cc.altLine,strokeWidth:1,fill:"transparent"});
      push({type:"i-text",text:"Subject: Warning Letter",x:50,y:248,fontSize:13,fontFamily:"Arial",fontWeight:"bold",fill:"#b91c1c"});
      push({type:"i-text",text:"Dear [Employee Name],\n\nThis letter formally notifies you that your conduct/performance falls below the standards\nexpected by [Company Name].",x:50,y:280,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-100});
      push({type:"rect",x:50,y:355,width:pW-100,height:65,fill:"#fef2f2",stroke:"#fca5a5",strokeWidth:1,cornerRadius:6});
      push({type:"i-text",text:"Issue / Violation:\n[Describe the specific issue here]",x:70,y:368,fontSize:12,fontFamily:"Arial",fill:"#991b1b",width:pW-140});
      push({type:"i-text",text:"A repetition may result in further disciplinary action up to termination of employment.\nPlease respond in writing within 5 working days.",x:50,y:440,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-100});
      push({type:"line",x:50,y:pH-190,points:[0,0,pW-100,0],stroke:cc.altLine,strokeWidth:1,fill:"transparent"});
      push({type:"i-text",text:"",x:60,y:pH-142,fontSize:34,fontFamily:"'Dancing Script',cursive",fill:cc.text,width:220});
      push({type:"line",x:60,y:pH-96,points:[0,0,220,0],stroke:cc.text,strokeWidth:1,fill:"transparent"});
  ...
  {
    id:"increment-letter", name:"Salary Increment", category:"HR", headerH:85,
    desc:"Salary increment announcement letter",
    preview:(bg,cc)=>(
      <div className="w-full h-full flex flex-col overflow-hidden" style={{background:bg,padding:6}}>
    ...
    build:(pW,pH,cc,co,gId)=>{
      ...
      push({type:"i-text",text:"To,\n[Employee Name]\nEmployee ID: [Employee ID]\n[Designation] | [Department]",x:50,y:148,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-100});
      push({type:"line",x:50,y:230,points:[0,0,pW-100,0],stroke:cc.altLine,strokeWidth:1,fill:"transparent"});
      push({type:"i-text",text:"Subject: Salary Increment Effective [Date]",x:50,y:248,fontSize:13,fontFamily:"Arial",fontWeight:"bold",fill:"#6d28d9"});
      push({type:"i-text",text:"Dear [Employee Name],\n\nWe are pleased to inform you that after reviewing your performance, the management\nhas approved a salary increment effective from [Date].",x:50,y:280,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-100});
      push({type:"rect",x:50,y:355,width:pW-100,height:90,fill:"#f5f3ff",stroke:"#c4b5fd",strokeWidth:1,cornerRadius:6});
      push({type:"i-text",text:"Previous Salary:   PKR [Previous Amount]\nNew Salary:        PKR [Salary]\nEffective From:    [Date]",x:70,y:376,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-140});
      push({type:"i-text",text:"This increment reflects your excellent performance. We look forward to your\ncontinued dedication and contribution.",x:50,y:462,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-100});
      push({type:"line",x:50,y:pH-190,points:[0,0,pW-100,0],stroke:cc.altLine,strokeWidth:1,fill:"transparent"});
      push({type:"i-text",text:"",x:60,y:pH-142,fontSize:34,fontFamily:"'Dancing Script',cursive",fill:cc.text,width:220});
      push({type:"line",x:60,y:pH-96,points:[0,0,220,0],stroke:cc.text,strokeWidth:1,fill:"transparent"});
      push({type:"i-text",text:"AUTHORIZED SIGNATORY",x:60,y:pH-84,fontSize:9,fontFamily:"Arial",fontWeight:"bold",fill:cc.sub});
  ...
  {
    id:"leave-approval", name:"Leave Approval", category:"HR", headerH:85,
    desc:"Official leave approval letter",
    preview:(bg,cc)=>(
      <div className="w-full h-full flex flex-col overflow-hidden" style={{background:bg,padding:6}}>
    ...
    build:(pW,pH,cc,co,gId)=>{
      ...
      push({type:"i-text",text:"To,\n[Employee Name]\nEmployee ID: [Employee ID]\n[Designation] | [Department]",x:50,y:148,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-100});
      push({type:"line",x:50,y:230,points:[0,0,pW-100,0],stroke:cc.altLine,strokeWidth:1,fill:"transparent"});
      push({type:"i-text",text:"Subject: Leave Approval",x:50,y:248,fontSize:13,fontFamily:"Arial",fontWeight:"bold",fill:"#0f766e"});
      push({type:"i-text",text:"Dear [Employee Name],\n\nYour leave has been approved as per the details below:",x:50,y:280,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-100});
      push({type:"rect",x:50,y:338,width:pW-100,height:90,fill:"#f0fdfa",stroke:"#99f6e4",strokeWidth:1,cornerRadius:6});
      push({type:"i-text",text:"Leave Type:   Annual / Casual / Medical\nFrom Date:    [From Date]\nTo Date:      [To Date]\nTotal Days:   [Duration]",x:70,y:354,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-140});
      push({type:"i-text",text:"Please ensure all pending work is handled before your leave.",x:50,y:446,fontSize:12,fontFamily:"Arial",fill:cc.text,width:pW-100});
      push({type:"line",x:50,y:pH-190,points:[0,0,pW-100,0],stroke:cc.altLine,strokeWidth:1,fill:"transparent"});
      push({type:"i-text",text:"",x:60,y:pH-142,fontSize:34,fontFamily:"'Dancing Script',cursive",fill:cc.text,width:220});
      push({type:"line",x:60,y:pH-96,points:[0,0,220,0],stroke:cc.text,strokeWidth:1,fill:"transparent"});
      push({type:"i-text",text:"AUTHORIZED SIGNATORY",x:60,y:pH-84,fontSize:9,fontFamily:"Arial",fontWeight:"bold",fill:cc.sub});
    ...
    <div className="p-4 space-y-5">
      <div className="bg-emerald-50 border border-emerald-200 rounded-xl p-3">
        <p className="text-[11px] text-emerald-800 font-medium leading-relaxed">
          Click to load a letter template. Edit text by double-clicking on canvas.
        </p>
      </div>
      {categories.map(cat => (
        <div key={cat}>
          ...
          <div className="space-y-2">
            {LETTER_TEMPLATES.filter(t => t.category === cat).map(t => (
              ...
              >
                <div className="h-[76px] w-full overflow-hidden relative">{t.preview(bgColor, cc)}</div>
...
const ElementsPanel = ({ onAdd, onAddTable }) => (
  <div className="p-4 space-y-5">
    ...
    <div>
      <p className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-3">Lines</p>
      <div className="grid grid-cols-3 gap-2">
        {LINE_SHAPES.map(sh => (
          <button key={sh.id} onClick={() => onAdd(sh.id)}
...
const TextPanel = ({ onAddText }) => (
  <div className="p-4 space-y-3">
    ...
    {[
      ...
      { label:"Small Caption",  opts:{ fontSize:10 },                    preview:"Small caption"  },
    ].map(t => (
...
const SIGNATURE_PRESETS = [
  { label:"Single — Auth",     cols:1, leftLabel:"Authorized Signatory" },
  { label:"Dual — Auth & HR",  cols:2, leftLabel:"Authorized Signatory", rightLabel:"HR Manager" },
  ...
  <div className="p-4 space-y-4">
    <div className="bg-amber-50 border border-amber-200 rounded-xl p-3">
      <p className="text-[11px] text-amber-800 font-medium leading-relaxed">
        Select a text element first, then click a variable to insert it.
      </p>
    </div>
    <div>
...
const DesignPanel = ({ bgColor, onBgChange, onResizePage, pageW, pageH }) => (
  <div className="p-4 space-y-5">
    <div>
      <p className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-3">Background</p>
      ...
      <div className="mt-2 flex items-center gap-2">
        <input type="color" value={bgColor} onChange={e=>onBgChange(e.target.value)} className="w-8 h-8 rounded-lg border border-slate-200 cursor-pointer"/>
        <input type="text" value={bgColor} onChange={e=>{ if(/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/.test(e.target.value)) onBgChange(e.target.value); }} maxLength={7}
    ...
    <div>
      ...
      <div className="space-y-1.5">
        {[{label:"A4 Portrait",w:750,h:1060},{label:"A4 Landscape",w:1060,h:750},{label:"US Letter",w:770,h:1000}].map(ps=>(
          <button key={ps.label} onClick={()=>onResizePage(ps.w,ps.h)}
            className={`w-full flex items-center justify-between px-3 py-2 border rounded-xl text-xs font-medium transition-all ${pageW===ps.w&&pageH===ps.h?"border-emerald-400 bg-emerald-50 text-emerald-700":"border-slate-200 hover:border-emerald-300 hover:bg-slate-50 text-slate-600"}`}
          >
            <span>{ps.label}</span><span className="text-slate-400">{ps.w}×{ps.h}</span>
          </button>
        ))}
      </div>
    </div>
  ...
  return (
    <div className="p-4 space-y-4">
      <div className="bg-gradient-to-br from-slate-50 to-slate-100 border border-slate-200 rounded-xl p-4 flex items-start gap-3">
        {logo ? <img src={logo} alt="" className="w-10 h-10 rounded-lg object-contain bg-white border border-slate-200 shrink-0"/>
               : <div className="w-10 h-10 rounded-lg bg-white border border-slate-200 flex items-center justify-center shrink-0"><Building2 size={16} className="text-slate-400"/></div>}
      ...
      <div>
        ...
        <div className="space-y-1.5">
          {logo && (
            <button onClick={()=>onAddImage(logo)} className="w-full flex items-center gap-3 px-3 py-2.5 bg-white border border-slate-200 rounded-xl hover:bg-emerald-50 hover:border-emerald-300 transition-all group text-left">
              <img src={logo} alt="" className="w-7 h-7 rounded object-contain border border-slate-100 shrink-0"/>
              <span className="text-xs font-medium text-slate-700 flex-1">Company Logo</span>
              <span className="text-[10px] text-slate-300 group-hover:text-emerald-400">+ add</span>
            </button>
          )}
          {company.name && (
            <button onClick={()=>onAddText(company.name,{fontSize:22,fontWeight:"bold"})} className="w-full flex items-center justify-between px-3 py-2.5 bg-white border border-slate-200 rounded-xl hover:bg-emerald-50 hover:border-emerald-300 transition-all group text-left">
              <div><p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-0.5">Company Name</p><p className="text-xs text-slate-700 font-medium truncate">{company.name}</p></div>
              <span className="text-[10px] text-slate-300 group-hover:text-emerald-400 shrink-0">+ add</span>
            </button>
          )}
          {company.companyAddress && (
            <button onClick={()=>onAddText(company.companyAddress,{fontSize:11})} className="w-full flex items-center justify-between px-3 py-2.5 bg-white border border-slate-200 rounded-xl hover:bg-emerald-50 hover:border-emerald-300 transition-all group text-left">
              <div><p className="text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-0.5">Address</p><p className="text-xs text-slate-700 font-medium truncate">{company.companyAddress}</p></div>
              <span className="text-[10px] text-slate-300 group-hover:text-emerald-400 shrink-0">+ add</span>
            </button>
          )}
        </div>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 py-2.5 bg-emerald-600 hover:bg-emerald-700 text-white text-xs font-bold rounded-xl transition-colors"
      >
  ...
  return (
    <div className="space-y-2">
      <div className="grid grid-cols-10 gap-1">
        {PALETTE.map(c=>(
          <button key={c} onClick={()=>onChange(c)} className={`w-5 h-5 rounded transition-all border-2 ${value===c?"border-emerald-500 scale-110 shadow":"border-transparent hover:border-slate-400"}`}
      ...
      <div className="flex items-center gap-2">
        <div className="relative w-7 h-7 rounded-lg border border-slate-200 cursor-pointer shrink-0 overflow-hidden" style={{background:current}}>
          <input ref={nativeRef} type="color" value={current} onChange={e=>onChange(e.target.value)} className="absolute inset-0 opacity-0 cursor-pointer w-full h-full"/>
        </div>
        <input type="text" value={value==="transparent"?"none":(value||"#000000")}
          ...
          maxLength={7} className="flex-1 text-[11px] font-mono border border-slate-200 rounded-lg px-2 py-1 bg-slate-50 outline-none focus:border-emerald-400"/>
        {allowNone&&<button onClick={()=>onChange("transparent")} className={`text-[10px] px-2 py-1 rounded-lg border transition-all ${value==="transparent"?"bg-slate-200 font-bold border-slate-400":"border-slate-200 hover:bg-slate-50"}`}>None</button>}
      </div>
    </div>
  );
};
...
const DrawPanel = ({ drawTool, setDrawTool, brushSize, setBrushSize, brushColor, setBrushColor }) => (
  <div className="p-4 space-y-5">
    <div className="space-y-2">
      ...
      {[{id:"select",icon:MousePointer2,label:"Select",desc:"Move & resize"},{id:"pen",icon:Pen,label:"Pen",desc:"Fine strokes"},{id:"brush",icon:Paintbrush,label:"Brush",desc:"Thick strokes"},{id:"eraser",icon:Eraser,label:"Eraser",desc:"Erase content"}].map(t=>(
        <button key={t.id} onClick={()=>setDrawTool(t.id)}
          className={`w-full flex items-center gap-3 px-3 py-2.5 rounded-xl border transition-all ${drawTool===t.id?"border-emerald-400 bg-emerald-50":"border-slate-200 bg-white hover:border-emerald-200"}`}
        >
          <div className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${drawTool===t.id?"bg-emerald-600 text-white":"bg-slate-100 text-slate-500"}`}><t.icon size={16}/></div>
          <div className="text-left"><p className={`text-xs font-semibold ${drawTool===t.id?"text-emerald-700":"text-slate-700"}`}>{t.label}</p><p className="text-[10px] text-slate-400">{t.desc}</p></div>
    ...
    {drawTool!=="select"&&(
      <>
        <div>
          ...
          <input type="range" min={1} max={30} value={brushSize} onChange={e=>setBrushSize(Number(e.target.value))} className="w-full accent-emerald-600"/>
          <p className="text-center text-[11px] text-slate-500 font-mono mt-1">{brushSize}px</p>
        </div>
        {drawTool!=="eraser"&&<div><p className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-2">Color</p><InlinePicker value={brushColor} onChange={setBrushColor}/></div>}
      </>
    )}
  </div>
);
...
const PropertiesPanel = ({ props: p, onUpdate, onAlignH, onAlignV, onDelete, onDuplicate, onMoveUp, onMoveDown, onBringToFront, onSendToBack, onClose }) => {
  if (!p) return null;
  const isText = ["i-text","textbox","text"].includes(p.type);
      ...
      <div className="flex-1 p-4 space-y-5">
        {isText&&(
          <div className="space-y-3">
            ...
            <select value={p.fontFamily||"Arial"} onChange={e=>onUpdate("fontFamily",e.target.value)} className="w-full text-xs border border-slate-200 rounded-lg px-2 py-2 bg-slate-50 outline-none focus:border-emerald-400">
              {FONT_FAMILIES.map(f=><option key={f} value={f}>{f}</option>)}
            </select>
            <Row label="Size"><NumInput val={p.fontSize} onChange={v=>onUpdate("fontSize",v)} min={6} max={200} suffix="px"/></Row>
            <div className="flex items-center gap-1.5">
              <button onClick={()=>onUpdate("fontWeight",p.fontWeight==="bold"?"normal":"bold")} className={`p-2 rounded-lg border text-sm font-bold transition-all ${p.fontWeight==="bold"?"bg-emerald-600 text-white border-emerald-600":"border-slate-200 hover:bg-slate-50"}`}>B</button>
              <button onClick={()=>onUpdate("fontStyle",p.fontStyle==="italic"?"normal":"italic")} className={`p-2 rounded-lg border text-sm italic transition-all ${p.fontStyle==="italic"?"bg-emerald-600 text-white border-emerald-600":"border-slate-200 hover:bg-slate-50"}`}>I</button>
              <button onClick={()=>onUpdate("underline",!p.underline)} className={`p-2 rounded-lg border text-sm underline transition-all ${p.underline?"bg-emerald-600 text-white border-emerald-600":"border-slate-200 hover:bg-slate-50"}`}>U</button>
            </div>
            <div className="flex items-center gap-1">
              {[["left",AlignLeft],["center",AlignCenter],["right",AlignRight]].map(([v,Icon])=>(
                <button key={v} onClick={()=>onUpdate("textAlign",v)} className={`flex-1 flex items-center justify-center p-2 rounded-lg border transition-all ${p.textAlign===v?"bg-emerald-600 text-white border-emerald-600":"border-slate-200 hover:bg-slate-50"}`}><Icon size={13}/></button>
              ))}
            </div>
            <div><p className="text-[11px] text-slate-400 font-semibold mb-1.5">Color</p><InlinePicker value={p.fill||"#000000"} onChange={v=>onUpdate("fill",v)}/></div>
            <div>
              <p className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest mb-1.5">Signature Styles</p>
              <div className="grid grid-cols-2 gap-1">
                {SIG_FONTS.map(f=>(
                  <button key={f.id} onClick={()=>onUpdate("fontFamily",f.css)} className={`px-2 py-1.5 rounded-lg border text-left transition-all ${p.fontFamily===f.css?"border-emerald-400 bg-emerald-50":"border-slate-200 bg-white hover:border-emerald-200"}`}>
        ...
        {!isText&&(
          <div className="space-y-3">
            ...
            <div><p className="text-[11px] text-slate-400 font-semibold mb-1.5">Fill</p><InlinePicker value={p.fill||"#3b82f6"} onChange={v=>onUpdate("fill",v)} allowNone/></div>
            <div><p className="text-[11px] text-slate-400 font-semibold mb-1.5">Stroke</p><InlinePicker value={p.stroke||"transparent"} onChange={v=>onUpdate("stroke",v)} allowNone/>
              <div className="mt-1.5"><Row label="Width"><NumInput val={p.strokeWidth} onChange={v=>onUpdate("strokeWidth",v)} min={0} max={20} suffix="px"/></Row></div>
            </div>
          </div>
        )}
        <div className="space-y-2">
          <p className="text-[10px] font-extrabold text-slate-400 uppercase tracking-widest">Position</p>
        ...
        <div className="space-y-2">
          ...
          <div className="flex items-center gap-1">
            ...
            {[["left","L"],["center","C"],["right","R"]].map(([v,l])=>(
              <button key={v} onClick={()=>onAlignH(v)} className="flex-1 text-[10px] font-semibold py-1.5 border border-slate-200 rounded-lg hover:bg-emerald-50 hover:border-emerald-300 hover:text-emerald-700 transition-all">{l}</button>
            ))}
          </div>
          <div className="flex items-center gap-1">
            <span className="text-[10px] text-slate-400 w-10 shrink-0">Vert</span>
            {[["top","T"],["middle","M"],["bottom","B"]].map(([v,l])=>(
              <button key={v} onClick={()=>onAlignV(v)} className="flex-1 text-[10px] font-semibold py-1.5 border border-slate-200 rounded-lg hover:bg-emerald-50 hover:border-emerald-300 hover:text-emerald-700 transition-all">{l}</button>
            ))}
          </div>
        </div>
        <div className="space-y-2">
          ...
          <div className="grid grid-cols-2 gap-1.5">
            {[{label:"Bring Fwd",fn:onMoveUp,icon:MoveUp},{label:"Send Back",fn:onMoveDown,icon:MoveDown},{label:"To Front",fn:onBringToFront,icon:Layers},{label:"To Back",fn:onSendToBack,icon:Layers}].map(({label,fn,icon:Icon})=>(
              <button key={label} onClick={fn} className="flex items-center gap-1.5 px-2 py-2 text-[10px] font-semibold border border-slate-200 rounded-lg hover:bg-slate-50 text-slate-600 transition-all"><Icon size={11}/>{label}</button>
            ))}
          </div>
        </div>
        <div className="flex gap-2 pt-2 border-t border-slate-100">
          <button onClick={onDuplicate} className="flex-1 flex items-center justify-center gap-1.5 py-2 border border-slate-200 rounded-lg text-[11px] font-semibold text-slate-600 hover:bg-slate-50 transition-all"><Copy size={12}/> Duplicate</button>
          <button onClick={onDelete} className="flex-1 flex items-center justify-center gap-1.5 py-2 border border-red-200 rounded-lg text-[11px] font-semibold text-red-500 hover:bg-red-50 transition-all"><Trash2 size={12}/> Delete</button>
        </div>
      </div>
    </aside>
  );
...
/* ═══════════ MAIN EDITOR — Employee Letter Template Canvas ═══════════ */
export default function EmployeeLetterCanvasPage() {
  ...
  const [templateName, setTemplateName]= useState("Untitled Letter");
  ...
  const setShapes = useCallback((updater) => {
    _setShapes(prev => {
      ...
      let ns = h.stack.slice(0, h.idx + 1);
      ns.push(next);
      if (ns.length > 60) ns = ns.slice(ns.length - 60);
      h.stack = ns; h.idx = ns.length - 1;
      return next;
    });
  }, []);
  ...
  const handleUndo = useCallback(() => {
    ...
    h.idx -= 1; _setShapes(h.stack[h.idx]);
  ...
  const addShape = useCallback((shape) => {
    ...
    setSelectedId(s.id); dirty.current = true;
  ...
  /* Load template from templates collection */
  useEffect(() => {
    const load = async () => {
      try {
        ...
        if (res.data.success) {
          ...
          setTemplate(t);
          setTemplateName(t.templateName || "Untitled Letter");
  ...
  const handleAddTable = useCallback((rows, cols, hasHeader) => {
    const cellW=Math.min(120,(pageW-80)/cols), cellH=34;
    const startX=(pageW-cols*cellW)/2, startY=220;
    const ns=[];
    for(let r=0;r<rows;r++) for(let c=0;c<cols;c++) {
      const isH=hasHeader&&r===0, isA=!isH&&r%2===0;
    ...
    setShapes(p=>[...p,...ns]); dirty.current=true;
    toast.success(`${rows}×${cols} table added`);
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [pageW]);

  /* Add signature block */
  const handleAddSignatureBlock = useCallback((preset) => {
    const blockY=pageH-160, lineW=210, ns=[];
  ...
  const handleAddText = useCallback((text, opts={}) => {
    const cc = getContrastColors(bgColor);
    addShape({ type:"i-text", text, x:opts.left??pageW/2-150, y:opts.top??Math.min(200,pageH/4),
      fontSize:opts.fontSize||16, fontFamily:opts.fontFamily||"Arial",
      fontWeight:opts.fontWeight||"normal", fontStyle:opts.fontStyle||"normal",
      fill:opts.fill||cc.text, width:300 });
  ...
  const handleAlignH = useCallback((align) => {
    if (!selectedId) return;
    const s=shapes.find(x=>x.id===selectedId); if(!s) return;
    const w=(s.width||(s.radius||50)*2||100)*(s.scaleX||1);
    const x=align==="left"?0:align==="center"?(pageW-w)/2:pageW-w;
    updateShape(selectedId,{x}); setSelProps(prev=>prev?{...prev,left:Math.round(x)}:null);
  ...
  const handleAlignV = useCallback((align) => {
    ...
    updateShape(selectedId,{y}); setSelProps(prev=>prev?{...prev,top:Math.round(y)}:null);
  }, [selectedId, shapes, pageH, updateShape]);

  /* Delete / Duplicate / Layers */
  const handleDelete = useCallback(() => {
    if (selectedIds.length>0) { const idSet=new Set(selectedIds); setShapes(p=>p.filter(s=>!idSet.has(s.id))); setSelectedIds([]); setSelectedId(null); setSelProps(null); dirty.current=true; return; }
    if (!selectedId) return;
    setShapes(p=>p.filter(s=>s.id!==selectedId)); setSelectedId(null); setSelProps(null); dirty.current=true;
  ...
  const handleDuplicate = useCallback(() => {
    ...
    setShapes(p=>[...p,clone]); setSelectedId(clone.id); dirty.current=true;
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [selectedId, shapes]);

  const handleMoveUp=useCallback(()=>{ if(!selectedId)return; setShapes(p=>{const i=p.findIndex(s=>s.id===selectedId);if(i<0||i===p.length-1)return p;const n=[...p];[n[i],n[i+1]]=[n[i+1],n[i]];return n;}); },[selectedId]);
  const handleMoveDown=useCallback(()=>{ if(!selectedId)return; setShapes(p=>{const i=p.findIndex(s=>s.id===selectedId);if(i<=0)return p;const n=[...p];[n[i],n[i-1]]=[n[i-1],n[i]];return n;}); },[selectedId]);
  const handleBringToFront=useCallback(()=>{ if(!selectedId)return; setShapes(p=>{const i=p.findIndex(s=>s.id===selectedId);if(i<0||i===p.length-1)return p;const n=[...p];const[item]=n.splice(i,1);n.push(item);return n;}); toast.success("Brought to front"); },[selectedId]);
  const handleSendToBack=useCallback(()=>{ if(!selectedId)return; setShapes(p=>{const i=p.findIndex(s=>s.id===selectedId);if(i<=0)return p;const n=[...p];const[item]=n.splice(i,1);n.unshift(item);return n;}); toast.success("Sent to back"); },[selectedId]);
  ...
  const handleApplyLetterTemplate = useCallback(async (tmpl) => {
    ...
    if (logoSrc) {
      try {
        ...
        const lw=Math.round(img.naturalWidth*sc), lh=Math.round(img.naturalHeight*sc);
        const ly=tmpl.headerH>0?Math.round((tmpl.headerH-lh)/2):12;
        built.splice(tmpl.headerH>0?1:built.length,0,{id:genId(),type:"image",src:logoSrc,x:pageW-50-lw,y:ly,width:lw,height:lh,scaleX:1,scaleY:1,rotation:0,opacity:1});
      } catch { /* skip logo */ }
    }
    setShapes(built); setSelectedId(null); setTemplateName(tmpl.name); dirty.current=true;
  ...
  const handleExportPDF = useCallback(async () => {
    ...
    try {
      ...
      pdf.save(`${templateName||"letter-template"}.pdf`);
  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-[#f1f3f5]">
      ...
      <header className="h-[52px] shrink-0 flex items-center gap-3 px-4 bg-emerald-700 border-b border-emerald-800">
        ...
        />
        <span className="text-[10px] bg-white/20 text-white/80 px-2 py-0.5 rounded-full font-medium">Employee Letter Template</span>
        <div className="ml-auto flex items-center gap-2">
          ...
          >
            {exporting?<Loader2 size={12} className="animate-spin"/>:<FileDown size={12}/>} Preview PDF
          </button>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <nav className="w-16 shrink-0 bg-[#f5f5f5] border-r border-[#e6e6e6] flex flex-col items-center pt-2">
          {SIDEBAR_ITEMS.map(item => {
            ...
            return (
              <motion.button key={item.id} onClick={()=>handleSidebarItem(item.id)}
                whileHover={{scale:1.06,backgroundColor:"#e6e6e6"}} whileTap={{scale:0.93}}
                transition={{type:"spring",stiffness:400,damping:20}}
                className={`w-full flex flex-col items-center justify-center gap-1 py-3 text-[10px] font-semibold cursor-pointer relative ${isActive?"bg-[#e6e6e6] text-slate-800":"text-slate-500"}`}
              >
                {isActive&&<motion.div layoutId="sidebar-active-tmpl" className="absolute left-0 top-0 bottom-0 w-[3px] bg-emerald-500 rounded-r-full" transition={{type:"spring",stiffness:400,damping:30}}/>}
                <motion.div animate={{color:isActive?"#059669":undefined}} transition={{duration:0.15}}><item.icon size={18}/></motion.div>
        ...
        <div className="relative shrink-0 flex">
          <motion.div className="bg-white border-r border-[#e6e6e6] overflow-hidden h-full"
            animate={{width:activePanel&&!panelCollapsed?280:0}} transition={{type:"spring",stiffness:320,damping:32}}>
            <AnimatePresence mode="wait">
              {activePanel&&!panelCollapsed&&(
                <motion.div key={activePanel} className="w-[280px] h-full flex flex-col"
                  ...
                  <div className="flex items-center gap-2 px-4 py-3 border-b border-[#e6e6e6] shrink-0">
                    <span className="text-sm font-bold text-slate-800 capitalize">{SIDEBAR_ITEMS.find(i=>i.id===activePanel)?.label}</span>
                    <button onClick={()=>setActivePanel(null)} className="ml-auto p-1 rounded-lg hover:bg-slate-100 text-slate-400"><X size={14}/></button>
                  </div>
                  <div className="flex-1 overflow-y-auto [&::-webkit-scrollbar]:hidden">
                    {activePanel==="templates" && <TemplatesPanel bgColor={bgColor} company={company} onApplyTemplate={handleApplyLetterTemplate}/>}
        ...
        <main className="flex-1 overflow-auto bg-[#f1f3f5] py-8 px-6">
          <div style={{minWidth:pageW+48}} className="mx-auto flex flex-col items-center gap-4">
            <div style={{position:"relative"}}>
              ...
              <KonvaCanvas
                stageRef={stageRef} shapes={shapes} selectedId={selectedId} selectedIds={selectedIds}
                onSelect={(id)=>{ setSelectedId(id); setSelectedIds([]); }}
                onSelectMultiple={(ids)=>{ setSelectedIds(ids); setSelectedId(null); }}
                onChange={updateShape} drawTool={drawTool} brushColor={brushColor} brushSize={brushSize}
                bgColor={bgColor} pageW={pageW} pageH={pageH}
                drawingLine={drawingLine} setDrawingLine={setDrawingLine} setShapes={setShapes} dirty={dirty}
              />
            </div>
            {!loading&&(
              <div className="flex items-center gap-4 text-[11px] text-slate-400 pb-4">
                ...
                <span>Double-click text to edit · Variables will be auto-filled when assigned</span>
              </div>
            )}
          </div>
        </main>
        ...
        {/* Properties panel */}
        <PropertiesPanel
          props={selProps} onUpdate={handleUpdateProp} onAlignH={handleAlignH} onAlignV={handleAlignV}
          onDelete={handleDelete} onDuplicate={handleDuplicate} onMoveUp={handleMoveUp} onMoveDown={handleMoveDown}
