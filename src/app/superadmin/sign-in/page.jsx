...
import {
  Loader2, Eye, EyeOff, Mail, Lock, Users, BarChart3,
  ShieldCheck, Building2, CheckCircle2, ArrowRight,
} from "lucide-react";
      ...
      <div className="hidden lg:flex lg:w-[52%] bg-gradient-to-br from-[#EEF4FF] via-white to-blue-100 flex-col justify-between p-10 relative overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <h1 className="text-3xl font-black text-slate-900 leading-tight mb-3">
            The smarter way<br />to manage your<br />
            <span className="text-blue-600">workforce.</span>
          </h1>
          <p className="text-slate-500 text-sm leading-relaxed max-w-xs">
            All-in-one HR operations platform — attendance, payroll, contracts, and multi-company management in one place.
          </p>
        </div>
